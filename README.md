...
## Installation
* Clone this repository: `git clone "https://github.com/VieetBubbles/AirBnB_clone_V3.git"`
...
* `def get(self, cls, id)` - returns a dictionary using a id
* `def count(self, cls=None)` - returns the number of objects listed as cls
